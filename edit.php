...
<div class="P" id="P1">
    <form action="update.php?id=<?=$row["id"]?>" method="post" id=form>
        <ul>
            ...
            <li><div class="input_li">content</div><textarea type="text" name="content" id="content" placeholder="Hello"><?=$row["content"]?></textarea></li>
            <input type="submit" value="update" id="send">
            </ul>
        </form>
    <input type="submit" value="delete" id="delete">
    <a href="top.php"><div id="btn">back</div></a>
